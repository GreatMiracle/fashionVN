    ...
    <div class="header-top">
        <div class="container">
            ...
            <div class="col-sm-4 logo">
                <a href="/"><img src="<c:url value='/template/images/logo.png'/>" alt=""></a>
            </div>

            <div class="col-sm-4 header-left">
<%--                <p class="log"><a href="/login">Login</a>--%>
<%--                    <span>or</span><a href="/register">Signup</a>--%>
<%--                </p>--%>
...
<%--                    <c:out value="${status_Log}"/>--%>
                </c:if>
                <c:if test="${not empty name_Session}">

                       <p class="log"><a href="#">Welcome: ${name_Session}</a>
                           <span>|</span><a href="/logout">Logout</a>
                       </p>
<%--                        <c:out value="${status_Log}"/>--%>
                </c:if>
<%--    <h1>em chao anh ${kien} ${testne}</h1>--%>

                <div class="cart box_1">
                    <a href="/cart">
                        <h3> <div class="total">
<%--                            <span class="simpleCart_total"></span></div>--%>
                            <img src="<c:url value='/template/images/cart.png'/>" alt=""/></h3>
                    </a>
    ...
    <div class="container">
        <div class="head-top">
            <div class="col-sm-2 number">
                <span><i class="glyphicon glyphicon-phone"></i>097 360 3391</span>
            </div>
                            ...
                            <div class="row">
                                <div class="col1">
                                    <div class="h_nav">
                                        <h4>All Clothing</h4>
                                        <ul>
                                            <c:forEach var="allDanhMuc" items="${allDanhMuc}">

                                                <li><a href="/product/${allDanhMuc.madanhmuc}">${allDanhMuc.tendanhmuc}</a></li>
...
<%--                                            <li><a href="products.html">Underwear & Socks</a></li>--%>
            ...
            <div class="clearfix"> </div>
            <!---pop-up-box---->
            <script type="text/javascript" src="<c:url value='/template/js/modernizr.custom.min.js'/>"></script>
