...
<html>
<head>
    <title>Admin Slidebar Left</title>
</head>
<body>
<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
    ...
    <nav class="navbar navbar-inverse">
        <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="/dashboard"><span class="fa fa-area-chart"></span>Fahsion<span class="dashboard_text">Việt Nam</span></a></h1>
        </div>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/adminproduct"><i class="fa fa-angle-right"></i> List Product</a></li>
                        <li><a href="/adminthemsanpham"><i class="fa fa-angle-right"></i> Add Product</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="charts.html">
