                ...
                <div class="form-three widget-shadow">
                    <form class="form-horizontal form-sanpham">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control1" id="nameinput" placeholder="Tên Sản Phẩm" name="tensanpham" value="${detailPro.tensanpham}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control1" id="moneyinput" placeholder="VNĐ" name="giatien" value="${detailPro.giatien}">
                            </div>
                        </div>
