...
<div class="main-content">
    ...
    <div id="page-wrapper">
        <div class="main-page">
            ...
            <!-- for amcharts js -->
            <script src="<c:url value='/template/adminTemplate/js/amcharts.js'/>"></script>
            <script src="<c:url value='/template/adminTemplate/js/serial.js'/>"></script>
            <script src="<c:url value='/template/adminTemplate/js/export.min.js'/>"></script>
            <link rel="stylesheet" href="<c:url value='/template/adminTemplate/css/export.css'/>" type="text/css" media="all" />
            <script src="<c:url value='/template/adminTemplate/js/light.js'/>"></script>
            <!-- for amcharts js -->

            <script  src="<c:url value='/template/adminTemplate/js/index1.js'/>"></script>
                ...
                <div class="mid-content-top charts-grids">
                    <div class="middle-content">
                        ...
                        <div id="owl-demo" class="owl-carousel text-center">
                            <div class="item">
                                <img class="lazyOwl img-responsive" data-src="<c:url value='/template/adminTemplate/images/slider1.jpg'/>" alt="name">
                            </div>
                            <div class="item">
                                <img class="lazyOwl img-responsive" data-src="<c:url value='/template/adminTemplate/images/slider2.jpg'/>" alt="name">
                            </div>
                            <div class="item">
                                <img class="lazyOwl img-responsive" data-src="<c:url value='/template/adminTemplate/images/slider3.jpg'/>" alt="name">
                            </div>
                            <div class="item">
                                <img class="lazyOwl img-responsive" data-src="<c:url value='/template/adminTemplate/images/slider4.jpg'/>" alt="name">
                            </div>
                            <div class="item">
                                <img class="lazyOwl img-responsive" data-src="<c:url value='/template/adminTemplate/images/slider5.jpg'/>" alt="name">
                            </div>
                            <div class="item">
                                <img class="lazyOwl img-responsive" data-src="<c:url value='/template/adminTemplate/images/slider6.jpg'/>" alt="name">
                            </div>
                            <div class="item">
                                <img class="lazyOwl img-responsive" data-src="<c:url value='/template/adminTemplate/images/slider7.jpg'/>" alt="name">
                            </div>
                    ...
                    <div class="activity_box">
                        ...
                        <div class="scrollbar" id="style-1">
                            <div class="activity-row">
                                <div class="col-xs-3 activity-img"><img src='<c:url value='/template/adminTemplate/images/1.jpg'/>' class="img-responsive" alt=""/></div>
                            ...
                            <div class="activity-row">
                                <div class="col-xs-3 activity-img"><img src='<c:url value='/template/adminTemplate/images/4.jpg'/>' class="img-responsive" alt=""/></div>
                                <div class="col-xs-7 activity-desc">
                            ...
                            <div class="activity-row">
                                <div class="col-xs-3 activity-img"><img src='<c:url value='/template/adminTemplate/images/3.jpg'/>' class="img-responsive" alt=""/></div>
                                <div class="col-xs-7 activity-desc">
                            ...
                            <div class="activity-row">
                                <div class="col-xs-3 activity-img"><img src='<c:url value='/template/adminTemplate/images/2.jpg'/>' class="img-responsive" alt=""/></div>
                                <div class="col-xs-7 activity-desc">
                    ...
                    <div class="activity_box activity_box1">
                        ...
                        <div class="scrollbar" id="style-3">
                            <div class="activity-row activity-row1">
                                <div class="col-xs-3 activity-img"><img src='<c:url value='/template/adminTemplate/images/1.jpg'/>' class="img-responsive" alt=""/><span>06:01 AM</span></div>
                            ...
                            <div class="activity-row activity-row1">
                                ...
                                <div class="col-xs-3 activity-img"><img src='<c:url value='/template/adminTemplate/images/3.jpg'/>' class="img-responsive" alt=""/><span>06:02 AM</span></div>
                                <div class="clearfix"> </div>
                            </div>
                            <div class="activity-row activity-row1">
                                <div class="col-xs-3 activity-img"><img src='<c:url value='/template/adminTemplate/images/1.jpg'/>' class="img-responsive" alt=""/><span>06:05 AM</span></div>
                                <div class="col-xs-5 activity-img1">
                                    <div class="activity-desc-sub">
                                        <h5>Michael Chris</h5>
                            ...
                            <div class="activity-row activity-row1">
                                ...
                                <div class="col-xs-3 activity-img"><img src='<c:url value='/template/adminTemplate/images/3.jpg'/>' class="img-responsive" alt=""/><span>06:20 PM</span></div>
                                <div class="clearfix"> </div>
                            </div>
                        </div>
                        <form action="#" method="post">
